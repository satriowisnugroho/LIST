                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            @if ($user->role == 'admin')
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.users.update', $userData->id) }}">
                            @else
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('operator.users.update', $userData->id) }}">
                            @endif
